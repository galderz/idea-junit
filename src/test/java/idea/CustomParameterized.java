...
/**
 * Allows the {@link CustomRunner} features in parameterized tests. This is
 * mostly copy-paste from {@link Parameterized} since the methods could not be
 * overridden.
 * <p>
 * The static {@link org.junit.BeforeClass} and {@link org.junit.AfterClass}
 * methods will be executed only once beforeQuery and afterQuery all tests
 * (since these should prepare static members). Hibernate-specific {@link
 * org.hibernate.testing.BeforeClassOnce} and {@link org.hibernate.testing.AfterClassOnce}
 * will be executed beforeQuery and afterQuery each set of tests with given
 * parameters.
 * <p>
 * Class can override the parameters list (annotated by {@link
 * org.junit.runners.Parameterized.Parameters} by defining static method of the
 * same name in inheriting class (this works although usually static methods
 * cannot override each other in Java).
 * <p>
 * When there are multiple methods providing the parameters list, the used
 * parameters list is a cross product of all the options, concatenating the
 * argument list according to {@link Order} values.
 * <p>
 * Contrary to {@link Parameterized}, non-static parameters methods are
 * allowed, but the test class needs to have parameterless constructor, and
 * therefore use {@link org.junit.runners.Parameterized.Parameter} for setting
 * these parameters. This allow type-safe overriding of the method; note that
 * only the base method needs the {@link org.junit.runners.Parameterized.Parameters}
...
public class CustomParameterized extends Suite {
   ...
   class CustomRunnerForParameters extends BlockJUnit4ClassRunner {
